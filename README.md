...
一套给 ComfyUI / Anima 用的多画师节点包，共 6 个节点。它想解决的问题很具体：多位画师写在一起出图时，**融合风格总是缺乏特点、不好看**，而且**融合风格难以稳定**。

> **先声明：这是完全的 vibe coding 产物**——所有代码都是 AI 写的，人类只负责指导方向和最后检测效果。
...
**一句话建议**：如果某几位画师直接写着就好看，那就直接写，别用这套东西，或者仅使用Mixer节点的 output_avg / base_preserve / lowrank_delta模式增加风格稳定性。其余则是直写出问题时的曲线救国工具。
